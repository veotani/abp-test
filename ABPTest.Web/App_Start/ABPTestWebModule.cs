...
namespace ABPTest.Web
{
    [DependsOn(
        ...
        typeof(ABPTestWebApiModule),
        typeof(ABPTestDataModule))]
    public class ABPTestWebModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.Localization.Sources.Add(
                new DictionaryBasedLocalizationSource(
                    ABPTestConsts.LocalizationSourceName,
                    new XmlFileLocalizationDictionaryProvider(
                        HttpContext.Current.Server.MapPath("~/Localization/ABPTest")
                        )
                    )
                );
